  ...
  n(function () {
    n.fn.infiniteslide = function (e) {
      var t = n.extend(
        ...
        o = function (e, t) {
          var r = n(e).children().clone().addClass("infiniteslide_clone");
          for (i = 1; i <= t; ) r.clone().appendTo(n(e)), i++;
        },
        a = function (e) {
          return (
            (w = 0),
        ...
        d = function (e, i, t, r) {
          ...
          n(e).css({
            animation:
              "infiniteslide" + i + " " + l(o, r) + "s linear 0s infinite" + d,
          });
        },
        u = function (e) {
          n(e)
      ...
      return this.each(function () {
        var e = n(this),
          i = Date.now() + Math.floor(1e4 * Math.random()).toString(16);
        1 == t.pauseonhover && u(e),
          n(window).on("load", function () {
            r(e, t.direction),
              o(e, t.clone),
              d(e, i, t.direction, t.speed),
              t.responsive &&
                n(window).on("resize", function () {
                  var i = p(e, t.direction),
                    r = e.attr("data-style"),
                    o = n("#" + r + "_style").html(),
                    a = o.replace(
